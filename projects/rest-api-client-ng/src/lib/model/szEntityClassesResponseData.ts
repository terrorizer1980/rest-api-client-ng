...
export interface SzEntityClassesResponseData {
    /**
     * The list of entity classes codes for the configured entity classes.
     */
    entityClasses?: Array<string>;
    /**
     * The list of `SzEntityClass` instances describing the configured entity classes.
     */
    entityClassDetails?: { [key: string]: SzEntityClass; };
}
