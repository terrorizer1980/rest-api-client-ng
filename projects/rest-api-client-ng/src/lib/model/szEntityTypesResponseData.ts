...
export interface SzEntityTypesResponseData {
    /**
     * The list of entity type codes for the configured entity types.
     */
    entityTypes?: Array<string>;
    /**
     * The list of `SzEntityType` instances describing the configured entity types.
     */
    entityTypeDetails?: { [key: string]: SzEntityType; };
}
