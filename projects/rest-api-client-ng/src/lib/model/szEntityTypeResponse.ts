 ...
 */
import { SzEntityTypeResponseData } from './szEntityTypeResponseData';
import { SzResponseWithRawData } from './szResponseWithRawData';

/**
 * The response describing an entity type.
 */
export interface SzEntityTypeResponse extends SzResponseWithRawData { 
    data?: SzEntityTypeResponseData;
}