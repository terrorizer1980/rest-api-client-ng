...
export interface SzEntityFeatureStatistics { 
    ...
    entityCount?: number;
    /**
     * Indicates if this feature value is no longer being used to find candidates because too many entities share the same value.
     */
    candidateCapReached?: boolean;
    /**
     * Indicates if this feature value is no longer being used in entity scoring because too many entities share the same value.
     */
    scoringCapReached?: boolean;
    /**
