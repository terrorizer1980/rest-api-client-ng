...
import { SzWhyRecordsResponseData } from './szWhyRecordsResponseData';

/**
 * The response describing the result of \"why\" operation.
 */
export interface SzWhyRecordsResponse extends SzResponseWithRawData {
    data?: SzWhyRecordsResponseData;
}
