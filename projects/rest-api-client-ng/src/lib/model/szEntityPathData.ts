...
export interface SzEntityPathData {
    ...
    /**
     * The array of `SzEntityData` objects describing the entities on the path.  This will include partial information on the first-degree related entities to the entity.
     */
