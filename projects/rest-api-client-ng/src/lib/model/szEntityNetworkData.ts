...
export interface SzEntityNetworkData {
    /**
     * The array of `SzEntityPath` objects describing the paths that make up the entity network (including island networks).
     */
    entityPaths?: Array<SzEntityPath>;
    /**
     * The array of `SzEntityData` objects describing the entities on the path.  This may only include partial information on the entities at the edge of the network.
     */
