...
import { SzWhyEntityResult } from './szWhyEntityResult';

export interface SzWhyEntityResponseData {
    /**
     * The `SzWhyEntityResults` describing why from each evaluated perspective within the entity.
     */
    whyResults?: Array<SzWhyEntityResult>;
    /**
     * The array of `SzEntityData` objects describing the entities involved in the response.  This will include partial information on the first-degree related entities to the entity.
     */
