 ...
 */
import { SzEntityClassResponseData } from './szEntityClassResponseData';
import { SzResponseWithRawData } from './szResponseWithRawData';

/**
 * The response describing an entity class.
 */
export interface SzEntityClassResponse extends SzResponseWithRawData { 
    data?: SzEntityClassResponseData;
}