 ...
 */
import { SzEntityClassesResponseData } from './szEntityClassesResponseData';
import { SzResponseWithRawData } from './szResponseWithRawData';

/**
 * The response describing the configured entity classes.
 */
export interface SzEntityClassesResponse extends SzResponseWithRawData { 
    data?: SzEntityClassesResponseData;
}