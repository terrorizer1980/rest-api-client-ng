...
import { SzWhyEntityResponseData } from './szWhyEntityResponseData';

/**
 * The response describing the result of \"why\" operation.
 */
export interface SzWhyEntityResponse extends SzResponseWithRawData {
    data?: SzWhyEntityResponseData;
}
