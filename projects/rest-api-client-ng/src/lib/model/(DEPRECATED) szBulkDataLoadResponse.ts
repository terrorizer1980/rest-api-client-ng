...
import { SzBulkLoadResult } from './szBulkLoadResult';

/**
 * The response describing the load statistics from loading a bulk data set.
 */
export interface SzBulkDataLoadResponse extends SzBaseResponse { 
    data?: SzBulkLoadResult;
}