 ...
 */
import { SzFlaggedRecord } from './szFlaggedRecord';

/**
 * An entity that was flagged as relevant due to the resolution operation.
 */
export interface SzFlaggedEntity { 
    /**
    ...
    flags?: Array<string>;
    /**
     * An array of objects describing sample records from the relevant entity and the triggered flags for that record.
     */
    sampleRecords?: Array<SzFlaggedRecord>;
}